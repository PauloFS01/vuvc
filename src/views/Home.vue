<template>
  <div class="home">
    ...
    <div class="div-arrangement">
      ...
      <div class="notifications">
        <div class="notification-div">
          <button-fill @click="change('bottom')" textbutton="Primary" color="primary" />
        </div>
        <div class="notification-div">
          <button-fill @click="change('top')" textbutton="Info" color="info" />
        </div>
        <div class="notification-div">
          <button-fill @click="change('left')" textbutton="Success" color="success" />
        </div>
        <div class="notification-div">
          <button-fill @click="change('right')" textbutton="Warning" color="warning" />
        </div>
        <div class="notification-div">
          <button-fill @click="change('center')" textbutton="Danger" color="danger" />
        </div>
      </div>
      <!-- end of notification -->
